 ...
 * @method static \SerenityTechnologies\NowPayments\DTOs\Response\PlanResponse getPlan(string|int $planId)
 * @method static \SerenityTechnologies\NowPayments\DTOs\Response\PlanResponse updatePlan(string|int $planId, array $data)
